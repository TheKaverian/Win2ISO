...
echo. >> "%PS%"
echo while ($true) { >> "%PS%"
echo     $o = Show-Menu 'Select a Windows version' $os_names 'Exit' >> "%PS%"
echo     if ($o -eq -1 -or $o -eq 8) { >> "%PS%"
echo         Clear-Host >> "%PS%"
echo         Write-Host "" >> "%PS%"
echo         Write-Host "  Win2ISO - Windows ISO Downloader" -ForegroundColor Green >> "%PS%"
echo         Write-Host "  =================================" -ForegroundColor DarkGreen >> "%PS%"
...
echo     if ($o -eq 7) { >> "%PS%"
echo         while ($true) { >> "%PS%"
echo             $moreItems = @('About Win2ISO','Win2ISO on GitHub','Credits','Legal','Back') >> "%PS%"
echo             $m = Show-Menu 'More' $moreItems >> "%PS%"
echo             if ($m -eq -1 -or $m -eq 4) { break } >> "%PS%"
echo             switch ($m) { >> "%PS%"
echo                 0 { >> "%PS%"
echo                     $esc = [char]27 >> "%PS%"
echo                     $aboutLines = @( >> "%PS%"
...
echo                         '  ^|  Windows 10  (multiple editions + LTSC)                               ^|', >> "%PS%"
